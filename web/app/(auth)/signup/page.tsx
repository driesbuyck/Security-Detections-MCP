        ...
        <div className="bg-card border border-border rounded-[var(--radius-card)] p-8">
          {success ? (
            ...
            <div className="text-center py-4">
              ...
              <Link
                href="/login"
                className="inline-block text-amber hover:text-amber-dim transition-colors text-sm"
              >
                Back to sign in
              </Link>
            </div>
            ...
            <>
              ...
              <p className="text-text-dim text-sm mb-6">
                Start mapping your detection coverage today.
              </p>
              ...
              <form onSubmit={handleEmailSignup} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    minLength={8}
                  />
                  <p className="text-text-dim/50 text-xs mt-1 font-[family-name:var(--font-mono)]">
